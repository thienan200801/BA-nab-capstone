...
export default function GetFee({location, subTotal}) {
    ...
    return (<div className="table total">
        ...
        <div className='shipping'>
            ...
            <div className='shipping-content'>{data?.fee?.shipping}</div>
        </div>
        <div className='shipping'>
            <div className='shipping-title'>Thuế <sup>đ</sup></div>
            <div className='shipping-content'>{data?.fee?.tax*subTotal}</div>
        </div>
        <div className='shipping total-price'>
        <div className='shipping-title'>Tổng cộng <sup>đ</sup></div>
            <div className='shipping-content total-price-content'>{data?.fee?.tax*subTotal + data?.fee?.shipping + subTotal}</div>
        </div>
    </div>)
}